...

{
    ...
    {
        $this->middleware('permission:Can Access Department')->only(['index', 'create', 'store', 'edit', 'update', 'destroy', 'departmentShow', 'departmentStore', 'departmentEditShow', 'departmentUpdate', 'departmentDestroy']);
    }
