                                ...
                                <div class="card-body p-md-5">
                                    <div class="row justify-content-center">
                                        <p class="card-text py-2">
                                            {{ __('Forgot your password? No problem. Just let us know your email address and we will email you a password reset code that will allow you to choose a new one.') }}
                                        </p>
                                        @if (session('status'))
