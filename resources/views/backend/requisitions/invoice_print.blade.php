...
<head>
    ...
    <title>Invoice for invoice number {{ $requisition->invoice_no}}</title>
            ...
            <tbody>
                ...
                @foreach ($requisition->requisitionProducts as $requisition_product)
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black; padding: 8px;">{{ $requisition_product->unit_price ?? 'N/A' }} TK</td>

                        <td style="border: 1px solid black; padding: 8px;">{{ $requisition_product->unit_price * $requisition_product->quantity }} TK</td> 
