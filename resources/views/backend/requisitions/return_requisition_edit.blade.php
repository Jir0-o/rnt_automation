    ...
    <div class="col-12 col-md-12">
                    ...
                    <div class="row" id="sharock_name">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="requisition_no" value="{{ $requisition->requisition_no }}" id="requisition_no"
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="requisition_date" value="{{ $requisition->requisition_date }}" id="requisition_date">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="hidden" id="edit_requisition_company_id" value="{{ $requisition->company_id }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="requisition_buyer_name" value="{{ $requisition->buyer_name }}" id="requisition_buyer_name" placeholder="Enter Buyer Name">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="requisition_address" value="{{ $requisition->address }}" id="requisition_address" placeholder="Enter Buyer Address">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="requisition_type" id="requisition_type">
                                    <option value="1" {{ $requisition->requisition_type == 1 ? 'selected' : '' }}>Cash Challan</option>
                                    <option value="2" {{ $requisition->requisition_type == 2 ? 'selected' : '' }}>Loan Challan</option>
                                    <option value="3" {{ $requisition->requisition_type == 3 ? 'selected' : '' }}>Sample Challan</option>
                                </select>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="sr_no" name="sr_no" value="{{ $requisition->sr_no }}" class="form-control">
                                <span class="text-danger" id="SubCategoryError"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-default" id="requisition-details">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between" id="requisition_button">
                                ...
                                <button class="btn btn-warning mx-auto" type="button" id="saveDraft_submit"><i
                                        class='bx bx-save' style="margin-left: -7px; margin-right: 3px;"></i>Save
                                        Draft</button> --}}
                                @endif
        ...
        $(document).ready(function() {
            ...
            $('#addMissingProductButton').on('click', function(e) {
                ...
                $.ajax({
                    url: "{{ route('edit.no.requisitions.add') }}",
                    type: 'POST',
                    data: {
            ...
            function getTempProduct() {
                $.ajax({
                    url: "{{ route('temprequisitions.add') }}", 
                    type: 'GET',
                    success: function(response) {
            ...
            $('#Product_Table').on('click', '.addProductBtn', function() {
                ...
                $.ajax({
                    url: "{{ route('temprequisitions.store') }}",
                    type: 'POST',
                    headers: {
                        "X-CSRF-TOKEN": "{{ csrf_token() }}",
                    },
        ...
        $(document).on('click', '#new_requisitions_submit', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // If "Yes" is clicked
                    submitRequisition("{{ route('editReturnRequisition.Submit', ':id') }}".replace(':id', requisitionId), false);
                } else if (result.dismiss === Swal.DismissReason.cancel) {
                    // If "No" is clicked
                    submitRequisition("{{ route('editReturnRequisition.noAuth', ':id') }}".replace(':id', requisitionId), true);
                }
            }).finally(() => {
        ...
        function submitRequisition(route, noFlag) {
            ...
            //     $.ajax({
            //         url: "{{ route('editReturnRequisition.Submit', ':id') }}".replace(':id', requisitionId), 
            //         type: 'PUT', 
            //         data: {
            //             requisition_date: $('#requisition_date').val(),
            //             category: $('input[name="category"]:checked').val(),
            ...
            $('#saveRequisitions_submit').on('click', function(e) {
                ...
                $.ajax({
                    url: "{{ route('saveReturnRequisition.Submit', ':id') }}".replace(':id', requisitionId), 
                    type: 'PUT', 
                    data: {
                        requisition_date: $('#requisition_date').val(),
                        category: $('input[name="category"]:checked').val(),
                ...
                $('#saveDraft_submit').on('click', function(e) {
                    ...
                    $.ajax({
                        url: "{{ route('saveDraftRequisition', ':id') }}".replace(':id', requisitionId), 
                        type: 'PUT', 
                        data: {
                            requisition_date: $('#requisition_date').val(),
                            category: $('input[name="category"]:checked').val(),
