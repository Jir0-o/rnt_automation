...
$(document).ready(function() {
    ...
    function getTempProduct() {
        $.ajax({
            url: "{{ route('temp-received-products.index') }}",
            type: 'GET',
            success: function(response) {
    ...
    $('#Product_Table').on('click', '.addProductBtn', function() {
        ...
        $.ajax({
            url: "{{ route('temp-received-products.store') }}",
            type: 'POST',
            headers: {
    ...
    $('#Temp_Requisitions_Table').on('click', '.removeProductBtn', function() {
        ...
        $.ajax({
            url: "{{ route('temp-received-products.destroy', ':id') }}".replace(':id',
                productId),
            type: 'DELETE',
            headers: {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
    ...
    .val(); // Get quantity for the same product row
        ...
        $.ajax({
            url: "{{ route('temp-received-products.update', ':id') }}".replace(':id',
                productId),
            type: 'PUT',
            headers: {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
    ...
    $('#requisitions_submit').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('received-products.store') }}",
            type: 'POST',
            headers: {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
            },
