    ...
    <div class="row justify-content-center">
        <div class="col-xl-10">
            <div class="profile-card">
                ...
                <div class="d-flex justify-content-between flex-wrap mb-4">
                    ...
                    <div class="tab-buttons" role="tablist" aria-label="Profile tabs">
                        <a href="{{ route('user.profile', ['tab' => 'profile']) }}"
                           class="btn {{ $activeTab === 'profile' ? 'active' : '' }}"
                           role="tab"
                        ...
                        <a href="{{ route('user.profile', ['tab' => 'password']) }}"
                           class="btn {{ $activeTab === 'password' ? 'active' : '' }}"
                           role="tab"
                ...
                {{-- Profile Info --}}
                <div class="pane {{ $activeTab !== 'profile' ? 'd-none' : '' }}" id="pane-profile" role="tabpanel" aria-labelledby="tab-profile">
                    <form id="profile-form" action="{{ route('user.update') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row gy-4">
                            <div class="col-md-4 text-center">
                                <div class="avatar-wrapper mx-auto">
                                    <img src="{{ $user->profile_photo_url }}" alt="Avatar" id="avatar-preview">
                                </div>
                                <div class="mb-2">
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name" class="input-custom" value="{{ old('name', $user->name) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="email" name="email" class="input-custom" value="{{ old('email', $user->email) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="error-text" id="error-current_password_for_email">
                                        @error('current_password_for_email') {{ $message }} @enderror
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {{-- Password --}}
                <div class="pane {{ $activeTab !== 'password' ? 'd-none' : '' }}" id="pane-password" role="tabpanel" aria-labelledby="tab-password">
                    <form id="password-form" action="{{ route('user.password') }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row gy-4">
                            <div class="col-md-4">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastify-js/1.12.0/toastify.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
