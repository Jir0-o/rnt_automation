...
<div class="row row-cols-0 row-cols-md-6">
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Low Stock Product')): ?>
    <div class="col mb-4 box" style="width: 50%;">
        <div class="card">
            <div class="card-body">
                <h3>STOCK ALERT</h3>
    ...
    <?php endif; ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Expiring Product')): ?>
    <div class="col mb-4 box" style="width: 50%;">
        <div class="card">
            <div class="card-body">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Order Report')): ?>
<div class="row row-cols-2 row-cols-md-6">
    <div class="col mb-4 box" style="width: 50%;">
        <div class="card">
            <div class="card-body text-center">
...
$(document).ready(function() {
    ...
    function GetTotalOrder() {
        return $.ajax({
            url: "<?php echo e(route('orders.total')); ?>",
            type: "GET",
            dataType: "json",
            success: function(response) {
                if (response.status == true) {
    ...
    function GetTodaysOrder() {
        return $.ajax({
            url: "<?php echo e(route('orders.today')); ?>",
            type: "GET",
            dataType: "json",
            success: function(response) {
                if (response.status == true) {
    ...
    function GetMonthlyOrderReport() {
        $.ajax({
            url: "<?php echo e(route('statistics.monthly.order')); ?>",
            type: "GET",
            dataType: "json",
            success: function(response) {
                if (response.status === true) {
    ...
    GetMonthlyOrderReport();
     ...
     function GetYearlyOrderReport() {
        $.ajax({
            url: "<?php echo e(route('yearly.order')); ?>",
            type: "GET",
            dataType: "json",
            success: function(response) {
                if (response.status === true) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RNT Automation\RNT Automation\resources\views/dashboard.blade.php ENDPATH**/ ?>