       ...
       <!-- Menu -->
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Can Access Inventory Manu')): ?>
                <li class="menu-item operation <?php echo e(request()->is('requisitions/create') || request()->is('allocations/create') || request()->is('get-invoice.create') || request()->is('purchases/create') ? 'open' : ''); ?>">
                    ...
                    <ul class="menu-sub">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Can Access Requisitions')): ?>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Can Access Create Invoice')): ?>
                        ...
                        <?php endif; ?> -->
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Can Access Purchase Invoice')): ?>
                ...
                <li class="menu-item all_item <?php echo e(request()->is('product/request/list') || request()->is('unit-types/create') || request()->is('product-sub-categories/create') || request()->is('product-categories/create') || request()->is('products/create') || request()->is('companies') ? 'open' : ''); ?>">
                    ...
                    <ul class="menu-sub">
                        ...
                        <?php if(Auth::user()->can('Can Access Unit Type')): ?>
                        ...
                        <?php endif; ?>
                        <?php if(Auth::user()->can('Can Access Company')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Can Access Designation')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Can Access Department')): ?>
        ...
        <!-- / Menu -->
<?php /**PATH C:\xampp\htdocs\RNT Automation\RNT Automation\resources\views/backend/includes/side-nav.blade.php ENDPATH**/ ?>