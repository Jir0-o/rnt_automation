    ...
    <div class="col-12 col-md-12">
                    ...
                    <div class="row" id="sharock_name">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="requisition_no" value="<?php echo e($requisition->order_no); ?>" id="requisition_no"
                        ...
                        <div class="col-6" >
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" value="<?php echo e($requisition->order_date); ?>" name="requisition_date" id="requisition_date" required>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select id="requisition_type" name="requisition_type" required class="form-control">
                                    <option disabled <?php echo e(is_null($requisition->order_type) ? 'selected' : ''); ?>>Select Order Type</option>
                                    <option value="1" <?php echo e($requisition->order_type == 1 ? 'selected' : ''); ?>>Cash Order</option>
                                    <option value="2" <?php echo e($requisition->order_type == 2 ? 'selected' : ''); ?>>Loan Order</option>
                                    <option value="3" <?php echo e($requisition->order_type == 3 ? 'selected' : ''); ?>>Sample Order</option>
                                </select>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#new_requisitions_submit', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('orders.update', ':id')); ?>".replace(':id', requisition_id),
                    type: 'POST',
                    data: {
        ...
        $('#auto-generate-btn').on('click', function() {
            ...
            //     $.ajax({
            //         url: "<?php echo e(route('orders.details' , ':id')); ?>".replace(':id', requisitionId),
            //         type: 'GET',
            //         dataType: 'json',
            //         success: function(response) {
            //             $('#order_id').empty();
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RNT Automation\RNT Automation\resources\views/backend/order/editOrder.blade.php ENDPATH**/ ?>