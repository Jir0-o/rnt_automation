                    ...
                    <div class="card card-default" id="help">
                        <div class="card-body">
                            ...
                            <label style="margin-right: 20px;">
                                <input type="radio" name="category" value="1" required <?php if($requisition->cc == 1): echo 'checked'; endif; ?>>
                                পণ্য ও সংশ্লিষ্ট সেবা
                            </label>
                            
                            <label style="margin-right: 20px;">
                                <input type="radio" name="category" value="2" required <?php if($requisition->cc == 2): echo 'checked'; endif; ?>>
                                কার্য ও ভৌত সেবা
                            </label>
                            
                            <label style="margin-right: 20px;">
                                <input type="radio" name="category" value="3" required <?php if($requisition->cc == 3): echo 'checked'; endif; ?>>
                                বৃদ্ধিবৃত্তিক সেবা
                            </label>
                            
                            <label>
                                <input type="radio" name="category" value="4" required <?php if($requisition->cc == 4): echo 'checked'; endif; ?>>
                                অন্যান্য সেবা
                            </label>
                            ...
                            <label style="margin-right: 20px;">
                                <input type="radio" name="category_two" value="1" required <?php if($requisition->auth == 1): echo 'checked'; endif; ?>>
                                অন্তর্ভুক্ত সেবা
                            </label>
                            
                            <label style="margin-right: 20px;">
                                <input type="radio" name="category_two" value="2" required <?php if($requisition->auth == 2): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Procurement_final\resources\views/backend/requisitions/return_requisition_edit.blade.php ENDPATH**/ ?>