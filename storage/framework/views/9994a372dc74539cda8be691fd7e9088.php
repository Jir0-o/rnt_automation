                        ...
                        <table id="Requisitions_Table" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($product->manufacturing_date)->format('d-F-Y')); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($product->expiry_date)->format('d-F-Y')); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RNT Automation\RNT Automation\resources\views/backend/products/createProduct.blade.php ENDPATH**/ ?>