    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <?php if($requisition->requisitionProducts->isEmpty()): ?>
                    <?php $__currentLoopData = $requisition->missingRequisitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $requisition_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($i++); ?></td>
                        ...
                        <?php if($index == 0): ?> 
                            ...
                            <td rowspan="<?php echo e(count($requisition->missingRequisitions)); ?>">
                                <?php echo $requisition->remarks ?? 'No comment available'; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <?php $__currentLoopData = $requisition->requisitionProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $requisition_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($i++); ?></td>
                        ...
                        <?php if($index == 0): ?> 
                            <!-- Add the new column with rowspan to span all rows and display raw HTML -->
                            <td rowspan="<?php echo e(count($requisition->requisitionProducts)); ?>">
                                <?php echo $requisition->remarks ?? 'No comment available'; ?>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                ...
                <button type="button" class="btn btn-success editReturnRequisitionBtn" data-id="<?php echo e($requisition->id); ?>" style="margin-right:5px;">
            ...
            $(document).ready(function() {
                ...
                $('#editRequisitionNo').on('click', function() {
                    ...
                    $('#requisitionNoInput').on('blur', function() {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('requisitions.number.update', ':id')); ?>"
                                .replace(
                                    ':id',
                                    requisition_id),
                            type: 'PUT',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Procurement_final\resources\views/backend/requisitions/return_requisition_show.blade.php ENDPATH**/ ?>