        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo side-logo d-flex flex-column align-items-center justify-content-center">
                <a href="<?php echo e(route('dashboard')); ?>" class="app-brand-link text-center">
                    <img class="img-fluid" src="<?php echo e(asset('RNT-Logo.png')); ?>" alt="RNT logo" loading="lazy" style="max-width: 100px; height: auto;">
                    <p class="m-0" style="font-size: 14px; line-height: 1.5;"> <span class="d-block">RNT Automation</span>
                    </p>
                </a>
            </div>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item all_item <?php echo e(request()->is('product/request/list') || request()->is('unit-types/create') || request()->is('product-sub-categories/create') || request()->is('product-categories/create') || request()->is('products/create') ? 'open' : ''); ?>">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <li class="menu-item intiator <?php echo e(request()->is('leisure-report') ? 'open' : ''); ?>">
                        <li class="menu-item <?php echo e(request()->is('leisure-report') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('leisure-report')); ?>" class="menu-link">
                                <!-- <i class="menu-icon bx bx-file"></i> -->
                                <div data-i18n="report">Stock Register</div>
        ...
        <!-- / Menu -->
<?php /**PATH D:\laragon\www\RNT Automation\resources\views/backend/includes/side-nav.blade.php ENDPATH**/ ?>