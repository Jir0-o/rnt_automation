                ...
                <table class="table text-center">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th scope="col">পাওয়ার সূত্র <br> সরবরাহকারীর নাম <br> চালান নং ও তারিখ</th>
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $leisureaccept; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $accept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($accept->purchase_from); ?> <br><?php echo e($storeNames[$accept->id] ?? 'N/A'); ?> <br> <?php echo e($accept->bill_no); ?> <br> <?php echo e(Carbon::parse($accept->date)->format('d-F-Y')); ?></td>
                                ...
                                <?php if($distribution): ?>
                                    ...
                                    <td>
                                        <?php if($officerSignatures[$distribution->id]): ?>
                                            <img src="<?php echo e(asset('global_assets/user_images/signature/' . $officerSignatures[$distribution->id])); ?>"
                                                alt="Signature" width="50">
                                        <?php else: ?>
...
<?php /**PATH C:\laragon\www\Procurement_final\resources\views/backend/initiator_file/printAuditReport.blade.php ENDPATH**/ ?>