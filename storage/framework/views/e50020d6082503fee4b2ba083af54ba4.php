...
<div class="bottom-buttons ">
    ...
    <button type="button" class="btn btn-info" id="backword" <?php if(!is_array($reviewStatusArray) ||
        count($reviewStatusArray)==1 || $file->is_forword == 0 || $file->sent_to != null): ?>
        disabled
        <?php endif; ?>
        >
    ...
    <a type="button" class="btn btn-info" href="<?php echo e(route('note-print')); ?>" <?php if($file->sent_to != null || count($reviewStatusArray) != 0): ?>
        disabled
        <?php endif; ?>
        >
...
$(document).ready(function() {
    ...
    $('#sendToCommitteeButton').on('click', function() {
        ...
        if (selectedCommitteeId) {
            ...
            $.ajax({
                ...
                type: 'POST', // Since your route is using a GET method
                data: formData,
                headers: {
                    "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",
                },
    ...
    $('#forward').on('click', function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('toc.forward')); ?>",
            type: 'POST',
            data: formData,
            headers: {
                "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",
            ...
            success: function(response) {
                ...
                window.location.href = "<?php echo e(route('toc.file.show')); ?>";
            },
            error: function(xhr, status, error) {
                console.error('Failed to submit note:', error);
                Toastify({
    ...
    $('#backword').on('click', function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('toc.backward')); ?>",
            type: 'POST',
            data: formData,
            headers: {
                "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Procurement_final\resources\views/backend/toc_file/note_show.blade.php ENDPATH**/ ?>