<?php $__env->startSection('content'); ?>
    ...
    <div class="card font-nikosh">
        <div class="container py-5">
            ...
            <?php endif; ?>
            <?php if(!$vc_id): ?>
                <a href="<?php echo e(route('tech.committee.list')); ?>" class="btn btn-secondary mt-3">
                    <i class="fas fa-arrow-left mx-1"></i> Back
                </a>
            <?php endif; ?>
            ...
            <div class="d-flex justify-content-between">
                ...
                <?php $__currentLoopData = $productCommittees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productCommittee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(
                        !$buttonShown &&
                            ...
                            $productCommittee->status != 3 &&
                            $productCommittee->status != 13 &&
                            $committeeSignatures->is_active == 1): ?>
                        <form action="<?php echo e(route('vc.approved.tech', $committee->requisition_id)); ?>" method="POST"
                ...
                <?php if($committee->status == 1 && Auth::id() == $committee->secretary): ?>
                    <div class="d-flex justify-content-end">
                        <form action="<?php echo e(route('committee.send.tech', [$committee->id])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-success">Send</button>
                        </form>
                    </div>
                <?php elseif($committee->status == 13 && Auth::id() == $committee->chairman_id): ?>
                    <div class="text-center mt-4">
                        <form action="<?php echo e(route('committee.send.tech', [$committee->id])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-success">Send</button>
    ...
    <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('vc.reject.tech', $committee->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="rejectChairmanModal" tabindex="-1" aria-labelledby="rejectChairmanModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('reject.tech.chairman', $committee->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Procurement_final\resources\views/backend/allocations/committee_report.blade.php ENDPATH**/ ?>