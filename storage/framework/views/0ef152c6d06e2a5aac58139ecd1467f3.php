...
$(document).ready(function() {
    ...
    $('#forward').on('click', function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('tec.forward')); ?>",
            type: 'POST',
            data: formData,
            headers: {
                "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Procurement_final\resources\views/backend/tec_file/note_show.blade.php ENDPATH**/ ?>