                ...
                <table id="Requisitions_Table" class="table">
                    ...
                    <tbody class="table-border-bottom-0" id="Categories-Table">
                        ...
                        <tr>
                            ...
                            <td><?php echo e($companies->buyer_name); ?></td>

                            <td><?php echo e($companies->address); ?></td>

                            

                            <td><?php echo e($companies->description ?? 'No Description found'); ?></td>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary editCompanyBtn"
                                    ...
                                    data-id="<?php echo e($companies->id); ?>">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.editCompanyBtn', function() {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('companies.show', ':id')); ?>".replace(':id', companyId),
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('companies.destroy', ':id')); ?>".replace(
    ...
    $('#EditCompany-Submit').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('companies.update', ':id')); ?>".replace(':id',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RNT Automation\RNT Automation\resources\views/company/createCompany.blade.php ENDPATH**/ ?>