...
<div class="watermark">
    ...
    <div class="container">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $requisition->requisitionProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black; padding: 8px;"><?php echo e($requisition_product->unit_price ?? 'N/A'); ?></td>
                        <td style="border: 1px solid black; padding: 8px;"><?php echo e($requisition_product->unit_price * $requisition_product->quantity); ?></td> 
                    </tr>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                <a href="<?php echo e(route('invoice.print', $requisition->id)); ?>" class="" target="_blank">
                    <button type="button" class="btn btn-success printInvoiceBtn" data-id="<?php echo e($requisition->id); ?>"
        ...
        $(document).ready(function() {
            ...
            $('#editInvoiceNo').on('click', function() {
                ...
                $('#invoiceNoInput').on('blur', function() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('invoice.number.update', ':id')); ?>".replace(
                            ':id',
                            invoice_id),
                        type: 'PUT',
                        headers: {
            ...
            $('#editOrderNo').on('click', function() {
                ...
                $('#orderNoInput').on('blur', function() {
                    ...
                    // Send an AJAX request to update the requisition number
                    $.ajax({
                        url: "<?php echo e(route('order.number.update', ':id')); ?>".replace(
                            ':id',
                            order_id),
                        type: 'PUT',
                        headers: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RNT Automation\resources\views/backend/requisitions/invoice_show.blade.php ENDPATH**/ ?>