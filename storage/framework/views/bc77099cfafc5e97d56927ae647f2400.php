                                ...
                                <div class="card-body p-md-5">
                                    <div class="row justify-content-center">
                                        <p class="card-text py-2">
                                            <?php echo e(__('Forgot your password? No problem. Just let us know your email address and we will email you a password reset code that will allow you to choose a new one.')); ?>
...
<?php endif; ?>
                                        <form method="POST" action="<?php echo e(route('forgot-password.store')); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php $component->withAttributes([]); ?>
                                                            <?php echo e(__('Email Password Reset Code')); ?>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RNT Automation\RNT Automation\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>