        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Can Access Create Order')): ?>
                    <div class="col-12 col-md-6">
                        <div class="float-end">
                    ...
                    <div class="table-responsive text-nowrap p-3">
                        <table id="datatable1" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($requisition->user->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($requisition->order_date)->format('d-F-Y')); ?>
                ...
                <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="table-responsive text-nowrap p-3">
                        <table id="datatable2" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                <?php $__currentLoopData = $pendingOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($requisition->user->name); ?></td>
                ...
                <div class="tab-pane fade" id="accepted" role="tabpanel" aria-labelledby="accepted-tab">
                    <div class="table-responsive text-nowrap p-3">
                        <table id="datatable3" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                <?php $__currentLoopData = $acceptOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($requisition->user->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($requisition->requisition_date)->format('d-F-Y')); ?>
                ...
                <div class="tab-pane fade" id="rejected" role="tabpanel" aria-labelledby="rejected-tab">
                    <div class="table-responsive text-nowrap p-3">
                        <table id="datatable4" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                <?php $__currentLoopData = $rejectOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($requisition->user->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($requisition->requisition_date)->format('d-F-Y')); ?>
                ...
                <div class="tab-pane fade" id="save" role="tabpanel" aria-labelledby="save-draft">
                    <div class="table-responsive text-nowrap p-3">
                        <table id="datatable5" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                <?php $__currentLoopData = $loanOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($requisition->user->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($requisition->requisition_date)->format('d-F-Y')); ?>
                ...
                <div class="tab-pane fade" id="loan" role="tabpanel" aria-labelledby="loan-req-tab">
                    <div class="table-responsive text-nowrap p-3">
                        <table id="datatable6" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                <?php $__currentLoopData = $saveOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($requisition->user->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($requisition->requisition_date)->format('d-F-Y')); ?>
                ...
                <div class="tab-pane fade" id="return" role="tabpanel" aria-labelledby="return-req-tab">
                    <div class="table-responsive text-nowrap p-3">
                        <table id="Allocations_Table" class="table">
                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                <?php $__currentLoopData = $returnOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($requisition->user->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($requisition->requisition_date)->format('d-F-Y')); ?>
...
$(document).ready(function() {
    ...
    $('#create_requisitions').on('click', function() {
        location.href = "<?php echo e(route('orders.create')); ?>";
    });
    ...
    $(document).on('click', '.showrequisitionBtn', function() {
        ...
        location.href = "<?php echo e(route('orders.show', ':id')); ?>".replace(':id', requisition_id);
    });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RNT Automation\RNT Automation\resources\views/backend/order/order.blade.php ENDPATH**/ ?>