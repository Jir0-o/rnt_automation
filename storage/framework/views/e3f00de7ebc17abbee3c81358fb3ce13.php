                            ...
                            <tbody class="table-border-bottom-0" id="Requisitions-Table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-warning">Waiting for Approvel..</span>
                                    ...
                                    <td>
                                        ...
                                        <?php if($inits->status == 0 && $inits->reviewer != null): ?> 
                                            <button type="button" class="btn btn-success showAcceptBtn"
                                                data-id="<?php echo e($inits->id); ?>">
                                                <i class="bx bx-check me-1"></i> Accept
                                            </button>

                                            <button type="button" class="btn btn-success" data-id="<?php echo e($inits->id); ?>"
                                                onclick="window.location.href='<?php echo e(route('initiator-file.edit', $inits->id)); ?>'">
                                                <i class="bx bx-edit me-1"></i> Edit
                                            </button>
                                            
                                            <button type="button" class="btn btn-danger showRejectBtn"
                                                data-id="<?php echo e($inits->id); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Procurement_final\resources\views/backend/initiator_file/file_operation.blade.php ENDPATH**/ ?>